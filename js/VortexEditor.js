...
export default class VortexEditor {
  ...
  async initialize() {
    ...
    document.addEventListener('keydown', async (event) => {
      if (event.key === 'Insert') {
        ...
        this.updatePanel.displayFirmwareUpdateInfo(device, 'N/A',
          latestVersion, 'https:/show.lol/community/downloads');
    ...
    window.addEventListener('message', (event) => {
      ...
      const allowed = ['https://vortex.community', 'https:/show.lol'];
  ...
  showHelpPopup(url = wikiUrl('show-lol/')) {
