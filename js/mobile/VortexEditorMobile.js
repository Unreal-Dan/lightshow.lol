...
(() => {
  ...
  root.style.cssText =
    'position:fixed;inset:0;z-index:2147483647;background:#000;color:#0f0;' +
    'font:12px/1.4 monospace;padding:8px;overflow:auto;white-space:pre-wrap';
  ...
  window.addEventListener('unhandledrejection', (e) => {
    line(`[unhandledrejection] ${fmt([e.reason])}`);
  });

  line(`[debug overlay enabled] ${location.href}`);
})();
