...
export default class ColorPickerPanel extends Panel {
  constructor(editor) {
    super(editor, 'colorPickerPanel', '', 'Color Picker', { showCloseButton: true });
    this.editor = editor;
  ...
  async open(index, colorSet, updateColorCallback) {
